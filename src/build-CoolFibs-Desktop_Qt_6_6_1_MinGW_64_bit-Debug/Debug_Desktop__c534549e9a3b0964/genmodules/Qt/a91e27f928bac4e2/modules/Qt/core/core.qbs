...
Module {
    ...
    property path binPath: "C:/Qt/6.6.1/mingw_64/bin"
    property path installPath: "C:/Qt/6.6.1/mingw_64/bin"
    property path incPath: "C:/Qt/6.6.1/mingw_64/include"
    property path libPath: "C:/Qt/6.6.1/mingw_64/lib"
    property path installPrefixPath: "C:/Qt/6.6.1/mingw_64"
    property path libExecPath: "C:/Qt/6.6.1/mingw_64/bin"
    property path qmlLibExecPath: "C:/Qt/6.6.1/mingw_64/bin"
    property path pluginPath: "C:/Qt/6.6.1/mingw_64/plugins"
    property string mkspecName: "win32-g++"
    property path mkspecPath: "C:/Qt/6.6.1/mingw_64/mkspecs/win32-g++"
    ...
    property path docPath: "C:/Qt/Docs/Qt-6.6.1"
    property string helpGeneratorLibExecPath: "C:/Qt/6.6.1/mingw_64/bin"
    ...
    property string libFilePathRelease: "C:/Qt/6.6.1/mingw_64/lib/libQt6Core.a"
    ...
    cpp.systemIncludePaths: ["C:/Qt/6.6.1/mingw_64/include","C:/Qt/6.6.1/mingw_64/include/QtCore"].concat(mkspecPath)
    cpp.libraryPaths: {
    ...
    cpp.staticLibraries: {
        ...
        if (qbs.targetOS.contains('windows') && !product.consoleApplication) {
            libs = libs.concat(qtBuildVariant === "debug"
                               ? undefined : ["C:/Qt/6.6.1/mingw_64/lib/libQt6EntryPoint.a"]);
        }
